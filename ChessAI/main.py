...
def load_images():
    ...
    for piece in pieces:
        image_path = r"C:\Users\parab\OneDrive\Desktop\GITDEMO\COC_Project_X_ChessAI\ChessAI\Images" + "\\" + piece + ".png"
...
def main():
    ...
    language = 'en'
    myobj = gtts.gTTS(text=text,tld = 'co.in', lang=language, slow=False)
    ...
    # whether the game is over ie (checkmate/stalemate)
    gameOver = False

    playerOne = True
    # If a Human is playing white , then this will be True
    # else if an AI playing then False

    playerTwo = False
    # same as for playerOne but here for black
    ...
    try:
            ...
            pass
    chess = p.transform.scale_by(p.image.load(r"C:\Users\parab\OneDrive\Desktop\GITDEMO\COC_Project_X_ChessAI\ChessAI\Images\chess.jpg"),0.25)
    ...
    while running:
        ...
        # True if a Human is playing and False if an AI is playing
        isHumanTurn = (gs.whitemove and playerOne) or (not gs.whitemove and playerTwo)
        ...
        for event in p.event.get():
            ...
            if event.type == p.QUIT:
                ...
                if not gameOver and isHumanTurn: 
                    # if its Human turn then allow mouseclicks but not for AI
                    # to avoid user from doing any mouseclicks after gameover
                    # but allows user to do keypresses
                    # mouse kaha h?
                            ...
                            # so check for it
                                ...
                                if move == valid_moves[i]:
                                    ...
                                    while move.pawn_promotion:
                                        ...
                                        screen.fill(p.Color("black"))
                                        screen.blit(p.transform.scale_by(p.image.load(r"C:\Users\parab\OneDrive\Desktop\GITDEMO\COC_Project_X_ChessAI\ChessAI\Images\PromotionMenu.jpg"),0.2),p.Rect(200-sq_size,200-sq_size,10,10))
...
def draw_game_state(screen,gs,valid_moves,sq_selected):
    ...
    # to highlight only sq calling it before drawing pieces 
    # else even piece gets highlighted with sq
...
def drawboard(screen):
    ...
    images = [p.image.load(r"C:\Users\parab\OneDrive\Desktop\GITDEMO\COC_Project_X_ChessAI\ChessAI\Images\ltb.jpg").convert_alpha(),p.image.load(r"C:\Users\parab\OneDrive\Desktop\GITDEMO\COC_Project_X_ChessAI\ChessAI\Images\dtb.jpg").convert_alpha()]
