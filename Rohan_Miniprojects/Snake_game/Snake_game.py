...
def welcome():
    while True:
        initial = pygame.image.load(r"C:\Users\parab\OneDrive\Documents\GitHub\COC_Project_X_ChessAI\Rohan_Miniprojects\Snake_game\initial.jpg").convert_alpha()
    ...
    while not exit_game: # game loop
        if game_over:
            ...
            if head in snake_list[:-1]:
                game_over = True
                pygame.mixer.music.load(r"C:\Users\parab\OneDrive\Documents\GitHub\COC_Project_X_ChessAI\Rohan_Miniprojects\Snake_game\game_over.wav")
