...
icon = p.image.load(r"C:\Users\MSHOME\Desktop\New folder\COC_Project_X_ChessAI\Chess\images\icon.png")
# rows and columns
dimensions = 8
...
def load_images():
    ...
    for piece in pieces:
        image_path = r"C:\Users\MSHOME\Desktop\New folder\COC_Project_X_ChessAI\Chess\images" + "\\" + piece + ".png"
